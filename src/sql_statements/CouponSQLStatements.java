...
public class CouponSQLStatements {
	 ...
	 * @return String represents SQL SELECT statement.
	 */
	public static String SELECT_COUPON_BY_ID() {
		return "SELECT * FROM coupon WHERE ID = ?";
	}
	 ...
	 * @return String represents SQL SELECT statement.
	 */
	public static String SELECT_COUPON_FROM_CUSTOMER_COUPON() {
		return "SELECT * FROM customer_coupon WHERE COUPON_ID = ?";
	}
	 ...
	 */
	public static String INSERT_INTO_COUPON() {
	 ...
	 */
	public static String UPDATE_COUPON() {
		return "UPDATE coupon SET END_DATE = ?, PRICE = ? WHERE ID = ?";
	}
	 ...
	 */
	public static String DELETE_COUPON() {
	 ...
	 * @return String represents SQL DELETE statement.
	 */
	public static String DELETE_FROM_COMPANY_COUPON() {
		return "DELETE FROM company_coupon WHERE COUPON_ID = ?";
	}
	 ...
	 * @return String represents SQL DELETE statement.
	 */
	public static String DELETE_FROM_CUSTOMER_COUPON() {
